---
name: refactoring
description: Enforce Refactoring (Martin Fowler) principles — behavior-preserving design work in small steps, preparatory refactoring before features, and targeted smell removal without rewrites or speculative abstraction. Use when changing existing code, preparing a feature or bug fix, reviewing cleanup, or reducing structural friction without intending to change observable behavior.
---
