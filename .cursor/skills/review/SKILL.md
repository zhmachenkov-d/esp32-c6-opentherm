...
1. Issue references in the commit messages (`#123`, `Closes #45`, etc.) — fetch the issue from GitHub if available.
...
Send a single message with two `Task` tool calls, both with `subagent_type: "generalPurpose"`.
