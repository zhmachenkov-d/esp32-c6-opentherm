...
name: teach
description: >-
  Runs a multi-session teaching workflow with MISSION.md, glossary, learning
  records, and exercises. Use when the user asks to teach, learn, or study a
  topic within this workspace.
